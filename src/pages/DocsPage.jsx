        ...
        <section className="min-h-screen">
          ...
          <article className="mb-8">
            ...
            <p className="text-base">
              Welcome to the documentation for the Spotify Search App. This
              project allows users to search for artists and view their albums
          ...
          <article className="my-8">
            ...
            <p className="text-base mt-3">
              Once the project is running, you can use the search bar on the
              home page to find artists and view their albums.
            </p>
          </article>
          ...
          <article className="my-8">
            ...
            <p className="text-base mb-3">
              This project integrates with the Spotify Web API to fetch data
              about artists and albums. Below are the key endpoints used in this
              application:
            </p>
            <ul className="list-disc list-inside space-y-4 text-base">
              <li>
                <strong>Search for an Artist:</strong> This endpoint searches
                for artists based on the user&apos;s input.
                <a
                ...
                <img
                  src={artistSearchScreenshot}
                  alt="Search for an Artist endpoint"
                  className="my-5 rounded-md shadow-sm w-full max-w-md border-2 border-black"
                />
              </li>
              <li>
                <strong>Get Artist&apos;s Albums:</strong> This endpoint
                retrieves a list of albums for a specific artist.
                <a
                  href="https://developer.spotify.com/documentation/web-api/reference/get-an-artists-albums"
                  className="text-blue-500 hover:underline ml-1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                ...
                <img
                  src={artistAlbumsScreenshot}
                  alt="Get Artist's Albums endpoint"
                  className="my-5 rounded-md shadow-sm w-full max-w-md border-2 border-black"
                />
              </li>
            </ul>
            <p className="text-base mt-4">
              ...
              .
              <img
                src={spotifyWebApiScreenshot}
                alt="Spotify Web API Documentation"
                className="my-5 rounded-md shadow-sm w-full max-w-md border-2 border-black"
              />
            </p>
          </article>
          ...
          <article className="my-8">
            ...
            <ol className="list-decimal ml-6 space-y-1 text-base">
              <li>
                Fork the repository and create a new branch for your feature or
                bug fix.
              </li>
              <li>
                Make your changes, ensuring you follow the project&apos;s coding
                style and conventions.
              </li>
              <li>Commit your changes with a descriptive commit message.</li>
              <li>
                Push your branch to your forked repository and open a pull
