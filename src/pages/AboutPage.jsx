            ...
            <div className="p-8 w-full max-w-4xl">
                ...
                <div className="p-4 mb-6">
                    ...
                    <p className="text-base">
                        This project is a simple full-stack application built using React, TailwindCSS, and the Spotify Web API. It provides a user-friendly interface for searching and displaying artist albums from Spotify. The goal was to create a tool that allows users to explore their favorite artists&apos; music more easily.
                    </p>
                </div>
                ...
                <div className="p-4 mb-6">
                    ...
                    <p className="text-base">
                        The project is designed with a component-based architecture using React. The main components include:
                    </p>
                    <ul className="list-disc ml-6 mt-2 text-base">
                        <li><strong>NavBar:</strong> Navigation across different pages.</li>
                        <li><strong>SearchBar:</strong> Allows users to search for artists.</li>
                        <li><strong>CardGrid:</strong> Displays albums in a grid layout.</li>
                        <li><strong>ItemCard:</strong> Represents individual album cards.</li>
                    </ul>
                </div>
